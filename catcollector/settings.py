...
import django_heroku # this was auto added but needs to be here if we use heroku
...
SECRET_KEY = 'django-insecure-&3gayhloa^e$kx74frq7nz)ge*tj#4rl@5d_$19b23czx1f&1*'
